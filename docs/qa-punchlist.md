...
| # | Parça | Bulgu | Durum |
|---|---|---|---|
| 1 | 1 · Ziyaretçi/SEO | ~~seo:audit canlı:~~ /nasil-calisir ve 6 sözleşme sayfası og:image yok (kök kart alt segmentlere miras geçmiyor); sözleşmelerde JSON-LD yok; kategori (86) ve ürün (83) başlıkları 75'i aşıyor; "Hakkında"sız firmada açıklama 30 karakter | **kapandı** — 2026-09-12 canlı denetim: "Sorun yok" |
