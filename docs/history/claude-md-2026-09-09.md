# ARŞİV — CLAUDE.md'nin 2026-09-09 tarihli tam hâli

> Bu dosya, kısaltılmadan önceki bağlam dosyasının **birebir kopyasıdır**
> (2.498 satır). CLAUDE.md o gün kural odaklı bir özete indirildi; buradaki
> tarihçe (Europages prompt serisi turları, panel revizyonları, denetim
> turları, commit gerekçeleri) **tarihsel kayıttır** — o günkü kodu anlatır,
> bugünkü sözcük/kararla yeniden yazılmamalıdır.
>
> Güncel kurallar için `CLAUDE.md`'ye bak; bir kararın GEREKÇESİNİ arıyorsan
> buraya.
