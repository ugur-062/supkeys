...
import { useRejectBuyerApplication } from "@/hooks/use-buyer-applications";
...
export function RejectBuyerModal({
  applicationId,
  companyName,
  open,
  onClose,
  ...
  const reject = useRejectBuyerApplication(applicationId);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    reject.mutate(
      ...
      {
        onSuccess: () => {
          toast.success("Başvuru reddedildi, müşteriye e-posta gönderildi");
          onRejected?.();
          onClose();
        },
        onError: (err) =>
          ...
          <form onSubmit={handleSubmit} className="px-5 py-5 space-y-4">
            ...
            <div className="space-y-1">
              ...
              <Textarea
                ...
                placeholder={
                  isOther
                    ? "Örn: Müşteri başka bir platform tercih etti"
              ...
              <div className="flex items-center justify-between text-xs">
                {otherError ? (
                  ...
                  <span className="text-admin-text-muted">
                    Müşteriye gönderilen e-postada görünür.
                  </span>
                )}
