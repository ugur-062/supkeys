        ...
        >
          ...
          <div className="px-5 py-5 space-y-3 text-sm text-admin-text">
            <p>
              ...
              tenant ve <em>COMPANY_ADMIN</em> kullanıcısı oluşturulacak,
              müşteriye &ldquo;hesabınız aktif&rdquo; e-postası gönderilecek.
            </p>
            {fromDemoCompanyName && (
              <p className="rounded-lg bg-warning-50 border border-warning-200 px-3 py-2 text-xs text-warning-700 leading-relaxed">
                Bu başvuru{" "}
                <strong>&ldquo;{fromDemoCompanyName}&rdquo;</strong> demo
