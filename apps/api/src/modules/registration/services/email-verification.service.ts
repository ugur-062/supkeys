...
export class EmailVerificationService {
  ...
  private async verifyBuyer(token: string) {
    // fromDemoRequest ilişkisi sadece admin paneldeki başvuru detayında
    // "demo davetli" rozeti göstermek için tutuluyor — auto-approve KULLANILMIYOR.
    // Tüm buyer başvuruları (self veya demo davetli) admin manuel onayından geçer.
