...
import { BidImportController } from "./import/bid-import.controller";
import { BidImportService } from "./import/bid-import.service";
...
@Module({
  ...
  exports: [CompanyListingsService, BidImportService],
})
