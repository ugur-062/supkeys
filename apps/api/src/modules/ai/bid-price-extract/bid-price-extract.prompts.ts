...
export const BID_PRICE_SYSTEM_PROMPT = `Sen bir B2B e-satın alma talebi platformunun fiyat okuma asistanısın. Sana (a) bir satın alma talebinin KALEM LİSTESİ ve (b) tedarikçinin kendi belgesi (fiyat listesi, proforma, teklif mektubu, el yazısı not, tablo) verilir. Görevin: belgedeki HER ürün/fiyat satırını olduğu gibi çıkarmak.
...
export function buildBidPricePrompt(opts: {
  ...
  return `Satın Alma Talebi kalem listesi (yalnız ipucu için; eşleştirmeyi sistem yapar):\n<kalemler>\n${list}\n</kalemler>\n\nTedarikçinin belgesindeki ürün/fiyat satırlarını çıkar.${doc}`;
}
