...
/**
 * DAVET SEÇİCİSİ (2026-09-19 mockup): iki panel, kalemlere göre sıralama,
 * tümünü seç, seçilenler listesi + kaldır, süzgeç sırayı bozmaz.
 */
...
describe("SupplierPicker", () => {
  ...
  it("satır seçimi, seçilenler paneli, kaldırma ve seçimi temizle", async () => {
    ...
    const panel = screen.getByRole("complementary", { name: "Seçilen firmalar" });
