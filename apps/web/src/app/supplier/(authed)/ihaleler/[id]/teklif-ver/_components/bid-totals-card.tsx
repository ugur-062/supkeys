...
export function BidTotalsCard({ tender }: Props) {
  ...
  return (
    <div className="bg-gradient-to-br from-zinc-50 via-white to-zinc-50/40 border border-zinc-200 rounded-2xl p-5">
      ...
      <div className="space-y-3">
        ...
        <div>
          ...
          <p className="font-bold text-zinc-900">
            <strong className="text-zinc-700">{filledCount}</strong>
        ...
        <div className="pt-3 border-t border-zinc-200">
          ...
          <p className="text-2xl font-semibold text-zinc-700 mt-1 tabular-nums">
            {totalLabel}
          </p>
        </div>
      </div>
