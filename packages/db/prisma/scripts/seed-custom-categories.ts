...
const CUSTOM_CATEGORIES: CustomCategory[] = [
  ...
  // ═══════════════════════════════════════════════════════════════════
  // V2-6.5 — MÜTEAHHİT KAPSAM TAMAMLAMA (tuğla, agrega, tesisat,
  // pompa, klima, sarf bağlantı, tel/örgü)
  // ═══════════════════════════════════════════════════════════════════

  // ─── 30880000 Tuğla ve Blok Malzemeler ───
  { code: "30880000", level: 2, nameTr: "Tuğla ve Blok Malzemeler", parentCode: "30000000" },
  { code: "30880100", level: 3, nameTr: "Tuğla (Delikli/Dolu)", parentCode: "30880000" },
  { code: "30880101", level: 4, nameTr: "8 Delikli Tuğla", parentCode: "30880100" },
  { code: "30880102", level: 4, nameTr: "Dolu Tuğla (Klinker)", parentCode: "30880100" },
  { code: "30880103", level: 4, nameTr: "Harman Tuğlası", parentCode: "30880100" },
  { code: "30880104", level: 4, nameTr: "Yatay Delikli (29×19×8.5)", parentCode: "30880100" },
  { code: "30880105", level: 4, nameTr: "Düşey Delikli (19×19×13.5)", parentCode: "30880100" },
  { code: "30880200", level: 3, nameTr: "Refrakter (Yangına Dayanıklı)", parentCode: "30880000" },
  { code: "30880201", level: 4, nameTr: "Şamot Tuğla", parentCode: "30880200" },
  { code: "30880202", level: 4, nameTr: "Asitli Refrakter Tuğla", parentCode: "30880200" },
  { code: "30880300", level: 3, nameTr: "Bims Blok", parentCode: "30880000" },
  { code: "30880301", level: 4, nameTr: "Bims Bloğu 40×20×10", parentCode: "30880300" },
  { code: "30880302", level: 4, nameTr: "Bims Bloğu 40×20×15", parentCode: "30880300" },
  { code: "30880303", level: 4, nameTr: "Bims Bloğu 40×20×20", parentCode: "30880300" },
  { code: "30880400", level: 3, nameTr: "Gaz Beton (Ytong)", parentCode: "30880000" },
  { code: "30880401", level: 4, nameTr: "Gaz Beton 600×250×100", parentCode: "30880400" },
  { code: "30880402", level: 4, nameTr: "Gaz Beton 600×250×150", parentCode: "30880400" },
  { code: "30880403", level: 4, nameTr: "Gaz Beton 600×250×200", parentCode: "30880400" },
  { code: "30880404", level: 4, nameTr: "Gaz Beton 600×250×250", parentCode: "30880400" },
  { code: "30880500", level: 3, nameTr: "Beton Blok", parentCode: "30880000" },
  { code: "30880501", level: 4, nameTr: "Taşıyıcı Beton Blok", parentCode: "30880500" },
  { code: "30880502", level: 4, nameTr: "Dolgu Beton Blok", parentCode: "30880500" },
  { code: "30880503", level: 4, nameTr: "Bordür Beton", parentCode: "30880500" },
  { code: "30880504", level: 4, nameTr: "Parke Taşı", parentCode: "30880500" },

  // ─── 30890000 Agrega Malzemeleri ───
  { code: "30890000", level: 2, nameTr: "Agrega Malzemeleri", parentCode: "30000000" },
  { code: "30890100", level: 3, nameTr: "Kum", parentCode: "30890000" },
  { code: "30890101", level: 4, nameTr: "Yıkanmış Kum (0-4 mm)", parentCode: "30890100" },
  { code: "30890102", level: 4, nameTr: "Dere Kumu", parentCode: "30890100" },
  { code: "30890103", level: 4, nameTr: "Mermer Tozu (Beyaz)", parentCode: "30890100" },
  { code: "30890104", level: 4, nameTr: "Silis Kumu", parentCode: "30890100" },
  { code: "30890200", level: 3, nameTr: "Çakıl", parentCode: "30890000" },
  { code: "30890201", level: 4, nameTr: "Çakıl 4-12 mm", parentCode: "30890200" },
  { code: "30890202", level: 4, nameTr: "Çakıl 12-25 mm", parentCode: "30890200" },
  { code: "30890203", level: 4, nameTr: "Çakıl 25-40 mm", parentCode: "30890200" },
  { code: "30890300", level: 3, nameTr: "Mıcır", parentCode: "30890000" },
  { code: "30890301", level: 4, nameTr: "Bazalt Mıcır", parentCode: "30890300" },
  { code: "30890302", level: 4, nameTr: "Granit Mıcır", parentCode: "30890300" },
  { code: "30890303", level: 4, nameTr: "Kalker Mıcır", parentCode: "30890300" },
  { code: "30890400", level: 3, nameTr: "Dolgu Malzemesi", parentCode: "30890000" },
  { code: "30890401", level: 4, nameTr: "Kazı Dolgu (Toprak)", parentCode: "30890400" },
  { code: "30890402", level: 4, nameTr: "Stabilize Dolgu", parentCode: "30890400" },

  // ─── 40900000 Tesisat Boruları (Detay) ───
  { code: "40900000", level: 2, nameTr: "Tesisat Boruları (Detay)", parentCode: "40000000" },
  { code: "40900100", level: 3, nameTr: "PVC Atık Su Borusu", parentCode: "40900000" },
  { code: "40900101", level: 4, nameTr: "PVC Ø32 mm", parentCode: "40900100" },
  { code: "40900102", level: 4, nameTr: "PVC Ø50 mm", parentCode: "40900100" },
  { code: "40900103", level: 4, nameTr: "PVC Ø75 mm", parentCode: "40900100" },
  { code: "40900104", level: 4, nameTr: "PVC Ø100 mm", parentCode: "40900100" },
  { code: "40900105", level: 4, nameTr: "PVC Ø125 mm", parentCode: "40900100" },
  { code: "40900106", level: 4, nameTr: "PVC Ø160 mm", parentCode: "40900100" },
  { code: "40900107", level: 4, nameTr: "PVC Ø200+ mm", parentCode: "40900100" },
  { code: "40900200", level: 3, nameTr: "PP-R Sıcak Su Borusu", parentCode: "40900000" },
  { code: "40900201", level: 4, nameTr: "PP-R Ø20 mm", parentCode: "40900200" },
  { code: "40900202", level: 4, nameTr: "PP-R Ø25 mm", parentCode: "40900200" },
  { code: "40900203", level: 4, nameTr: "PP-R Ø32 mm", parentCode: "40900200" },
  { code: "40900204", level: 4, nameTr: "PP-R Ø40 mm", parentCode: "40900200" },
  { code: "40900205", level: 4, nameTr: "PP-R Ø50+ mm", parentCode: "40900200" },
  { code: "40900300", level: 3, nameTr: "PEX Çapraz Polietilen", parentCode: "40900000" },
  { code: "40900301", level: 4, nameTr: "PEX Ø16 mm", parentCode: "40900300" },
  { code: "40900302", level: 4, nameTr: "PEX Ø20 mm", parentCode: "40900300" },
  { code: "40900303", level: 4, nameTr: "PEX Ø25 mm", parentCode: "40900300" },
  { code: "40900400", level: 3, nameTr: "Galvaniz Çelik Boru", parentCode: "40900000" },
  { code: "40900401", level: 4, nameTr: "GZ Boru 1/2 inç", parentCode: "40900400" },
  { code: "40900402", level: 4, nameTr: "GZ Boru 3/4 inç", parentCode: "40900400" },
  { code: "40900403", level: 4, nameTr: "GZ Boru 1 inç", parentCode: "40900400" },
  { code: "40900404", level: 4, nameTr: "GZ Boru 1 1/4 inç", parentCode: "40900400" },
  { code: "40900405", level: 4, nameTr: "GZ Boru 1 1/2 inç+", parentCode: "40900400" },
  { code: "40900500", level: 3, nameTr: "Paslanmaz Çelik Boru", parentCode: "40900000" },
  { code: "40900501", level: 4, nameTr: "304 Paslanmaz (Genel)", parentCode: "40900500" },
  { code: "40900502", level: 4, nameTr: "316 Paslanmaz (Gıda/Marine)", parentCode: "40900500" },
  { code: "40900600", level: 3, nameTr: "Bakır Boru", parentCode: "40900000" },
  { code: "40900601", level: 4, nameTr: "Bakır Boru Ø10 mm", parentCode: "40900600" },
  { code: "40900602", level: 4, nameTr: "Bakır Boru Ø15 mm", parentCode: "40900600" },
  { code: "40900603", level: 4, nameTr: "Bakır Boru Ø22 mm", parentCode: "40900600" },
  { code: "40900700", level: 3, nameTr: "Demir Döküm Boru", parentCode: "40900000" },
  { code: "40900701", level: 4, nameTr: "Döküm Boru Ø50 mm", parentCode: "40900700" },
  { code: "40900702", level: 4, nameTr: "Döküm Boru Ø100 mm", parentCode: "40900700" },

  // ─── 40910000 Vana ve Armatür ───
  { code: "40910000", level: 2, nameTr: "Vana ve Armatür", parentCode: "40000000" },
  { code: "40910100", level: 3, nameTr: "Küresel Vana", parentCode: "40910000" },
  { code: "40910101", level: 4, nameTr: "1/2 inç Küresel Vana", parentCode: "40910100" },
  { code: "40910102", level: 4, nameTr: "3/4 inç Küresel Vana", parentCode: "40910100" },
  { code: "40910103", level: 4, nameTr: "1 inç Küresel Vana", parentCode: "40910100" },
  { code: "40910104", level: 4, nameTr: "1 1/4 inç+ Küresel Vana", parentCode: "40910100" },
  { code: "40910105", level: 4, nameTr: "Pirinç Küresel Vana", parentCode: "40910100" },
  { code: "40910106", level: 4, nameTr: "Paslanmaz Küresel Vana", parentCode: "40910100" },
  { code: "40910200", level: 3, nameTr: "Glob Vana", parentCode: "40910000" },
  { code: "40910201", level: 4, nameTr: "1/2-3/4 inç Glob Vana", parentCode: "40910200" },
  { code: "40910202", level: 4, nameTr: "1-2 inç Glob Vana", parentCode: "40910200" },
  { code: "40910300", level: 3, nameTr: "Kelebek Vana", parentCode: "40910000" },
  { code: "40910301", level: 4, nameTr: "Kelebek Vana DN50", parentCode: "40910300" },
  { code: "40910302", level: 4, nameTr: "Kelebek Vana DN80", parentCode: "40910300" },
  { code: "40910303", level: 4, nameTr: "Kelebek Vana DN100", parentCode: "40910300" },
  { code: "40910304", level: 4, nameTr: "Kelebek Vana DN150+", parentCode: "40910300" },
  { code: "40910400", level: 3, nameTr: "Çek Valf", parentCode: "40910000" },
  { code: "40910401", level: 4, nameTr: "Mantar Tipi Çek Valf", parentCode: "40910400" },
  { code: "40910402", level: 4, nameTr: "Kanatlı Çek Valf", parentCode: "40910400" },
  { code: "40910500", level: 3, nameTr: "Filtre ve Strainer", parentCode: "40910000" },
  { code: "40910501", level: 4, nameTr: "Y Tip Filtre", parentCode: "40910500" },
  { code: "40910502", level: 4, nameTr: "Su Filtresi (Sedimentes)", parentCode: "40910500" },
  { code: "40910600", level: 3, nameTr: "Conta ve Salmastra", parentCode: "40910000" },

  // ─── 40920000 Pompa ve Hidrofor ───
  { code: "40920000", level: 2, nameTr: "Pompa ve Hidrofor", parentCode: "40000000" },
  { code: "40920100", level: 3, nameTr: "Sirkülasyon Pompası", parentCode: "40920000" },
  { code: "40920101", level: 4, nameTr: "Sirkülasyon 25-40 (Konut)", parentCode: "40920100" },
  { code: "40920102", level: 4, nameTr: "Sirkülasyon 25-60", parentCode: "40920100" },
  { code: "40920103", level: 4, nameTr: "Sirkülasyon 32-80 (Ticari)", parentCode: "40920100" },
  { code: "40920200", level: 3, nameTr: "Hidrofor Sistemi", parentCode: "40920000" },
  { code: "40920201", level: 4, nameTr: "Hidrofor 1 HP", parentCode: "40920200" },
  { code: "40920202", level: 4, nameTr: "Hidrofor 2-3 HP", parentCode: "40920200" },
  { code: "40920203", level: 4, nameTr: "Hidrofor 5 HP+", parentCode: "40920200" },
  { code: "40920300", level: 3, nameTr: "Dalgıç Pompa", parentCode: "40920000" },
  { code: "40920301", level: 4, nameTr: "Atık Su Dalgıç", parentCode: "40920300" },
  { code: "40920302", level: 4, nameTr: "Drenaj Dalgıç", parentCode: "40920300" },
  { code: "40920400", level: 3, nameTr: "Sondaj Pompası", parentCode: "40920000" },
  { code: "40920401", level: 4, nameTr: "Derin Kuyu Pompası", parentCode: "40920400" },
  { code: "40920402", level: 4, nameTr: "Yatay Yüzey Pompa", parentCode: "40920400" },

  // ─── 40930000 Klima ve Havalandırma ───
  { code: "40930000", level: 2, nameTr: "Klima ve Havalandırma", parentCode: "40000000" },
  { code: "40930100", level: 3, nameTr: "Split Klima", parentCode: "40930000" },
  { code: "40930101", level: 4, nameTr: "9000 BTU Split", parentCode: "40930100" },
  { code: "40930102", level: 4, nameTr: "12000 BTU Split", parentCode: "40930100" },
  { code: "40930103", level: 4, nameTr: "18000 BTU Split", parentCode: "40930100" },
  { code: "40930104", level: 4, nameTr: "24000 BTU Split", parentCode: "40930100" },
  { code: "40930105", level: 4, nameTr: "36000 BTU+ Split", parentCode: "40930100" },
  { code: "40930200", level: 3, nameTr: "Salon ve Mobil Klima", parentCode: "40930000" },
  { code: "40930201", level: 4, nameTr: "Inverter Salon Klima", parentCode: "40930200" },
  { code: "40930202", level: 4, nameTr: "Mobil Klima", parentCode: "40930200" },
  { code: "40930300", level: 3, nameTr: "VRV / VRF Sistem", parentCode: "40930000" },
  { code: "40930301", level: 4, nameTr: "VRV Dış Ünite (Outdoor)", parentCode: "40930300" },
  { code: "40930302", level: 4, nameTr: "VRV İç Ünite (Indoor)", parentCode: "40930300" },
  { code: "40930303", level: 4, nameTr: "VRV Aksesuarları (Branch, Reziduel)", parentCode: "40930300" },
  { code: "40930400", level: 3, nameTr: "Kanallı Tip Klima", parentCode: "40930000" },
  { code: "40930401", level: 4, nameTr: "Tavan Tipi Kanallı", parentCode: "40930400" },
  { code: "40930402", level: 4, nameTr: "Yer Tipi Kanallı", parentCode: "40930400" },
  { code: "40930500", level: 3, nameTr: "Havalandırma Fan", parentCode: "40930000" },
  { code: "40930501", level: 4, nameTr: "Aksiyel Fan (Eksenel)", parentCode: "40930500" },
  { code: "40930502", level: 4, nameTr: "Santrifüj Fan", parentCode: "40930500" },
  { code: "40930503", level: 4, nameTr: "Çatı Fanı (Roof)", parentCode: "40930500" },

  // ─── 31900000 Sarf Bağlantı Elemanları ───
  { code: "31900000", level: 2, nameTr: "Sarf Bağlantı Elemanları (Cıvata/Vida/Elektrod)", parentCode: "31000000" },
  { code: "31900100", level: 3, nameTr: "Metrik Cıvata (Galvaniz)", parentCode: "31900000" },
  { code: "31900101", level: 4, nameTr: "M6 Cıvata", parentCode: "31900100" },
  { code: "31900102", level: 4, nameTr: "M8 Cıvata", parentCode: "31900100" },
  { code: "31900103", level: 4, nameTr: "M10 Cıvata", parentCode: "31900100" },
  { code: "31900104", level: 4, nameTr: "M12 Cıvata", parentCode: "31900100" },
  { code: "31900105", level: 4, nameTr: "M16 Cıvata", parentCode: "31900100" },
  { code: "31900106", level: 4, nameTr: "M20 Cıvata", parentCode: "31900100" },
  { code: "31900107", level: 4, nameTr: "M24 Cıvata", parentCode: "31900100" },
  { code: "31900108", level: 4, nameTr: "M30+ Cıvata", parentCode: "31900100" },
  { code: "31900200", level: 3, nameTr: "Yüksek Mukavemet Cıvata", parentCode: "31900000" },
  { code: "31900201", level: 4, nameTr: "8.8 Sınıfı Cıvata", parentCode: "31900200" },
  { code: "31900202", level: 4, nameTr: "10.9 Sınıfı Cıvata", parentCode: "31900200" },
  { code: "31900203", level: 4, nameTr: "12.9 Sınıfı Cıvata", parentCode: "31900200" },
  { code: "31900300", level: 3, nameTr: "Somun", parentCode: "31900000" },
  { code: "31900301", level: 4, nameTr: "Standart Altıgen Somun M6-M16", parentCode: "31900300" },
  { code: "31900302", level: 4, nameTr: "Kilit Somun (Nylock)", parentCode: "31900300" },
  { code: "31900303", level: 4, nameTr: "Kapaklı Somun", parentCode: "31900300" },
  { code: "31900400", level: 3, nameTr: "Pul (Rondela)", parentCode: "31900000" },
  { code: "31900401", level: 4, nameTr: "Düz Rondela", parentCode: "31900400" },
  { code: "31900402", level: 4, nameTr: "Yaylı Rondela", parentCode: "31900400" },
  { code: "31900403", level: 4, nameTr: "Diş Rondela", parentCode: "31900400" },
  { code: "31900500", level: 3, nameTr: "Vida", parentCode: "31900000" },
  { code: "31900501", level: 4, nameTr: "Ahşap Vida", parentCode: "31900500" },
  { code: "31900502", level: 4, nameTr: "Sundurma (Sac) Vida", parentCode: "31900500" },
  { code: "31900503", level: 4, nameTr: "Drywall (Alçıpan) Vida", parentCode: "31900500" },
  { code: "31900504", level: 4, nameTr: "Hilti Çakma Çivi", parentCode: "31900500" },
  { code: "31900600", level: 3, nameTr: "Kaynak Elektrod ve Tel", parentCode: "31900000" },
  { code: "31900601", level: 4, nameTr: "E6013 Rutil (Genel)", parentCode: "31900600" },
  { code: "31900602", level: 4, nameTr: "E7018 Bazik (Yapı)", parentCode: "31900600" },
  { code: "31900603", level: 4, nameTr: "Paslanmaz Kaynak Elektrod (308L/316L)", parentCode: "31900600" },
  { code: "31900604", level: 4, nameTr: "MIG/MAG Alüminyum Tel", parentCode: "31900600" },
  { code: "31900605", level: 4, nameTr: "MIG/MAG Çelik Tel", parentCode: "31900600" },
  { code: "31900606", level: 4, nameTr: "TIG Tel ve Çubuk", parentCode: "31900600" },
  { code: "31900700", level: 3, nameTr: "Çivi", parentCode: "31900000" },
  { code: "31900701", level: 4, nameTr: "Beton Çivisi", parentCode: "31900700" },
  { code: "31900702", level: 4, nameTr: "Ahşap Çivisi", parentCode: "31900700" },
  { code: "31900703", level: 4, nameTr: "Galvaniz Çivisi", parentCode: "31900700" },

  // ─── 31910000 Tel ve Örgü Sistemleri ───
  { code: "31910000", level: 2, nameTr: "Tel ve Örgü Sistemleri", parentCode: "31000000" },
  { code: "31910100", level: 3, nameTr: "Hasır Tel (Donatı)", parentCode: "31910000" },
  { code: "31910101", level: 4, nameTr: "Q188 Hasır Çelik", parentCode: "31910100" },
  { code: "31910102", level: 4, nameTr: "Q221 Hasır Çelik", parentCode: "31910100" },
  { code: "31910103", level: 4, nameTr: "Q295 Hasır Çelik", parentCode: "31910100" },
  { code: "31910104", level: 4, nameTr: "Q378 Hasır Çelik", parentCode: "31910100" },
  { code: "31910200", level: 3, nameTr: "Çelik Tel Örgü (Çit)", parentCode: "31910000" },
  { code: "31910201", level: 4, nameTr: "Düz Tel Örgü (Galvaniz)", parentCode: "31910200" },
  { code: "31910202", level: 4, nameTr: "Plastik Kaplı Tel Örgü", parentCode: "31910200" },
  { code: "31910300", level: 3, nameTr: "Dikenli Tel", parentCode: "31910000" },
  { code: "31910301", level: 4, nameTr: "2 Sıra Dikenli Tel", parentCode: "31910300" },
  { code: "31910302", level: 4, nameTr: "4 Sıra Dikenli Tel", parentCode: "31910300" },
  { code: "31910303", level: 4, nameTr: "Jiletli Tel (Concertina)", parentCode: "31910300" },

  // ═══════════════════════════════════════════════════════════════════
  // V2-6.5 — ELEKTRİK PANO ÜRETİCİSİ kapsam (DIN ray, klemens, bara,
  // kablo papuç, kablo kanal, pano sacı, kabin aksesuar, iklim, toz boya)
  // ═══════════════════════════════════════════════════════════════════

  // ─── 39880000 Pano İçi Bağlantı Malzemeleri ───
  { code: "39880000", level: 2, nameTr: "Pano İçi Bağlantı Malzemeleri", parentCode: "39000000" },
  { code: "39880100", level: 3, nameTr: "DIN Ray (Montaj Rayı)", parentCode: "39880000" },
  { code: "39880101", level: 4, nameTr: "TS35 DIN Ray (35×7.5 Standart)", parentCode: "39880100" },
  { code: "39880102", level: 4, nameTr: "TS15 DIN Ray (Mini)", parentCode: "39880100" },
  { code: "39880103", level: 4, nameTr: "Delikli DIN Ray", parentCode: "39880100" },
  { code: "39880104", level: 4, nameTr: "DIN Ray Stopper (Kapama)", parentCode: "39880100" },
  { code: "39880200", level: 3, nameTr: "Klemens", parentCode: "39880000" },
  { code: "39880201", level: 4, nameTr: "Vidalı Klemens 2.5 mm²", parentCode: "39880200" },
  { code: "39880202", level: 4, nameTr: "Vidalı Klemens 4-6 mm²", parentCode: "39880200" },
  { code: "39880203", level: 4, nameTr: "Vidalı Klemens 10-16 mm²", parentCode: "39880200" },
  { code: "39880204", level: 4, nameTr: "Vidalı Klemens 35-95 mm²+", parentCode: "39880200" },
  { code: "39880205", level: 4, nameTr: "Yaylı (Cage Clamp) Klemens", parentCode: "39880200" },
  { code: "39880206", level: 4, nameTr: "Push-In Klemens", parentCode: "39880200" },
  { code: "39880207", level: 4, nameTr: "Çift Katlı (Double-Decker) Klemens", parentCode: "39880200" },
  { code: "39880208", level: 4, nameTr: "Toprak Klemensi (PE, Yeşil-Sarı)", parentCode: "39880200" },
  { code: "39880209", level: 4, nameTr: "Sigortalı Klemens", parentCode: "39880200" },
  { code: "39880300", level: 3, nameTr: "Pano İçi Kablo Kanalı (Gri PVC)", parentCode: "39880000" },
  { code: "39880301", level: 4, nameTr: "25×40 Kablo Kanalı", parentCode: "39880300" },
  { code: "39880302", level: 4, nameTr: "40×40 Kablo Kanalı", parentCode: "39880300" },
  { code: "39880303", level: 4, nameTr: "40×60 Kablo Kanalı", parentCode: "39880300" },
  { code: "39880304", level: 4, nameTr: "60×60 Kablo Kanalı", parentCode: "39880300" },
  { code: "39880305", level: 4, nameTr: "60×80 Kablo Kanalı", parentCode: "39880300" },
  { code: "39880306", level: 4, nameTr: "80×100 Kablo Kanalı+", parentCode: "39880300" },
  { code: "39880400", level: 3, nameTr: "Faston ve Kablo Papuçu (Lug)", parentCode: "39880000" },
  { code: "39880401", level: 4, nameTr: "Faston 6.3 mm (Dişi/Erkek)", parentCode: "39880400" },
  { code: "39880402", level: 4, nameTr: "Sıvama Papuç 2.5-10 mm²", parentCode: "39880400" },
  { code: "39880403", level: 4, nameTr: "Sıvama Papuç 16-35 mm²", parentCode: "39880400" },
  { code: "39880404", level: 4, nameTr: "Sıvama Papuç 50-95 mm²+", parentCode: "39880400" },
  { code: "39880405", level: 4, nameTr: "Halka Tipi Papuç", parentCode: "39880400" },
  { code: "39880406", level: 4, nameTr: "Wire End Ferrule (Pin)", parentCode: "39880400" },
  { code: "39880407", level: 4, nameTr: "Çift Pin Ferrule", parentCode: "39880400" },
  { code: "39880408", level: 4, nameTr: "Sıvama Pensi (Crimp Tool)", parentCode: "39880400" },
  { code: "39880500", level: 3, nameTr: "Kablo Bağı ve Etiketleme", parentCode: "39880000" },
  { code: "39880501", level: 4, nameTr: "Kablo Bağı 100-200 mm", parentCode: "39880500" },
  { code: "39880502", level: 4, nameTr: "Kablo Bağı 300-500 mm", parentCode: "39880500" },
  { code: "39880503", level: 4, nameTr: "Spiral Kablo Bandı", parentCode: "39880500" },
  { code: "39880504", level: 4, nameTr: "Kablo Numaratör (Sleeve)", parentCode: "39880500" },
  { code: "39880505", level: 4, nameTr: "Etiket Yazıcı Şerit (Brady/Dymo)", parentCode: "39880500" },
  { code: "39880600", level: 3, nameTr: "Bakır ve Alüminyum Bara", parentCode: "39880000" },
  { code: "39880601", level: 4, nameTr: "Bakır Bara 5×30 mm", parentCode: "39880600" },
  { code: "39880602", level: 4, nameTr: "Bakır Bara 8×40 mm", parentCode: "39880600" },
  { code: "39880603", level: 4, nameTr: "Bakır Bara 10×60 mm", parentCode: "39880600" },
  { code: "39880604", level: 4, nameTr: "Bakır Bara 10×80 mm", parentCode: "39880600" },
  { code: "39880605", level: 4, nameTr: "Bakır Bara 10×100 mm+", parentCode: "39880600" },
  { code: "39880606", level: 4, nameTr: "Alüminyum Bara", parentCode: "39880600" },
  { code: "39880607", level: 4, nameTr: "PEN / PE Topraklama Barası", parentCode: "39880600" },
  { code: "39880608", level: 4, nameTr: "Bara İzolatörü (Distance Holder)", parentCode: "39880600" },

  // ─── 39890000 Pano Gövde, Aksesuar ve İklim Kontrol ───
  { code: "39890000", level: 2, nameTr: "Pano Gövde, Aksesuar ve İklim", parentCode: "39000000" },
  { code: "39890100", level: 3, nameTr: "Pano Sacı (Galvaniz/Paslanmaz)", parentCode: "39890000" },
  { code: "39890101", level: 4, nameTr: "Galvaniz Pano Sacı 1.0-1.2 mm", parentCode: "39890100" },
  { code: "39890102", level: 4, nameTr: "Galvaniz Pano Sacı 1.5-2.0 mm", parentCode: "39890100" },
  { code: "39890103", level: 4, nameTr: "Galvaniz Pano Sacı 2.5-3.0 mm", parentCode: "39890100" },
  { code: "39890104", level: 4, nameTr: "Boyalı (Toz Boyalı) Sac", parentCode: "39890100" },
  { code: "39890105", level: 4, nameTr: "Paslanmaz 304 Pano Sacı", parentCode: "39890100" },
  { code: "39890106", level: 4, nameTr: "Paslanmaz 316 Pano Sacı (Marin)", parentCode: "39890100" },
  { code: "39890107", level: 4, nameTr: "DKP Soğuk Çekme Sac", parentCode: "39890100" },
  { code: "39890200", level: 3, nameTr: "Pano Kabin Aksesuarları", parentCode: "39890000" },
  { code: "39890201", level: 4, nameTr: "Pano Kilidi (3 Nokta)", parentCode: "39890200" },
  { code: "39890202", level: 4, nameTr: "Pano Kolu (Sap)", parentCode: "39890200" },
  { code: "39890203", level: 4, nameTr: "Pano Menteşesi", parentCode: "39890200" },
  { code: "39890204", level: 4, nameTr: "Conta / Pul Yastığı (IP Koruma)", parentCode: "39890200" },
  { code: "39890205", level: 4, nameTr: "Pano Camı / Transparan Kapı", parentCode: "39890200" },
  { code: "39890206", level: 4, nameTr: "Pano İçi Topraklama Çubuğu", parentCode: "39890200" },
  { code: "39890207", level: 4, nameTr: "Anahtar Kilidi (Sabotaj Karşıtı)", parentCode: "39890200" },
  { code: "39890208", level: 4, nameTr: "Pano İçi Cep / Belge Tutucu", parentCode: "39890200" },
  { code: "39890300", level: 3, nameTr: "Pano İklim Kontrol", parentCode: "39890000" },
  { code: "39890301", level: 4, nameTr: "Pano Fanı 60-92 mm", parentCode: "39890300" },
  { code: "39890302", level: 4, nameTr: "Pano Fanı 120-150 mm", parentCode: "39890300" },
  { code: "39890303", level: 4, nameTr: "Pano Filtresi (Toz)", parentCode: "39890300" },
  { code: "39890304", level: 4, nameTr: "Pano Isıtıcı (Anti-Kondensasyon)", parentCode: "39890300" },
  { code: "39890305", level: 4, nameTr: "Pano Termostat (Mekanik/Dijital)", parentCode: "39890300" },
  { code: "39890306", level: 4, nameTr: "Pano Higrostatı (Nem)", parentCode: "39890300" },
  { code: "39890307", level: 4, nameTr: "Pano İçi LED Aydınlatma", parentCode: "39890300" },
  { code: "39890308", level: 4, nameTr: "Pano Klimatizör (Cooling Unit)", parentCode: "39890300" },
  { code: "39890400", level: 3, nameTr: "Toz Boya (RAL)", parentCode: "39890000" },
  { code: "39890401", level: 4, nameTr: "Toz Boya RAL 7032 (Açık Gri)", parentCode: "39890400" },
  { code: "39890402", level: 4, nameTr: "Toz Boya RAL 7035 (Açık Gri)", parentCode: "39890400" },
  { code: "39890403", level: 4, nameTr: "Toz Boya RAL 9005 (Siyah)", parentCode: "39890400" },
  { code: "39890404", level: 4, nameTr: "Toz Boya RAL 5015 (Gök Mavisi)", parentCode: "39890400" },
  { code: "39890405", level: 4, nameTr: "Toz Boya RAL 6018 (Yeşil)", parentCode: "39890400" },
  { code: "39890406", level: 4, nameTr: "Toz Boya RAL 9010 (Beyaz)", parentCode: "39890400" },
  { code: "39890500", level: 3, nameTr: "Kablo Glandı (Cable Gland)", parentCode: "39890000" },
  { code: "39890501", level: 4, nameTr: "PG Kablo Glandı (Plastik)", parentCode: "39890500" },
  { code: "39890502", level: 4, nameTr: "Metric Kablo Glandı (M Tipi)", parentCode: "39890500" },
  { code: "39890503", level: 4, nameTr: "Pirinç Kablo Glandı", parentCode: "39890500" },
  { code: "39890504", level: 4, nameTr: "ATEX (Ex-Proof) Kablo Glandı", parentCode: "39890500" },
];
