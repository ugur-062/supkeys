 ...
 */
const segmentPhoto = (segment: string) => `/categories/${segment.slice(0, 2)}000000.webp`;
...
const COMPANIES: Co[] = [
  { key: "anadolu", name: "Anadolu İnşaat A.Ş.", tier: "GOLD", city: "Ankara", industry: "İnşaat ve altyapı", activities: ["SERVICE_PROVIDER"], founded: 1994, employees: "250-500", sell: ["72000000"], buy: ["30000000", "22000000"],
  ...
  { key: "ege", name: "Ege Tekstil San. Tic. A.Ş.", tier: "GOLD", city: "İzmir", industry: "Tekstil ve konfeksiyon", activities: ["MANUFACTURER", "IMPORTER_EXPORTER"], founded: 1987, employees: "500-1000", sell: ["11000000", "53000000"], buy: ["12000000"],
  ...
  { key: "marmara", name: "Marmara Gıda Ltd. Şti.", tier: "GOLD", city: "Bursa", industry: "Gıda üretimi", activities: ["MANUFACTURER"], founded: 2003, employees: "100-250", sell: ["50000000"], buy: ["24000000", "14000000"],
  ...
  { key: "toros", name: "Toros Kimya A.Ş.", tier: "GOLD", city: "Adana", industry: "Endüstriyel kimya", activities: ["MANUFACTURER", "DISTRIBUTOR"], founded: 1999, employees: "100-250", sell: ["12000000"], buy: ["24000000"],
  ...
  { key: "karadeniz", name: "Karadeniz Enerji A.Ş.", tier: "GOLD", city: "Samsun", industry: "Enerji ve elektrik", activities: ["SERVICE_PROVIDER", "DISTRIBUTOR"], founded: 2008, employees: "50-100", sell: ["26000000", "39000000"], buy: ["26000000", "39000000"],
  ...
  { key: "baskent", name: "Başkent Medikal Ltd. Şti.", tier: "GOLD", city: "Ankara", industry: "Medikal ve sağlık", activities: ["DISTRIBUTOR", "IMPORTER_EXPORTER"], founded: 2005, employees: "50-100", sell: ["42000000"], buy: ["42000000", "41000000"],
  ...
  { key: "akdeniz", name: "Akdeniz Lojistik A.Ş.", tier: "SILVER", city: "Mersin", industry: "Lojistik ve depolama", activities: ["SERVICE_PROVIDER"], founded: 2001, employees: "250-500", sell: ["78000000"], buy: ["24000000", "25000000"],
  ...
  { key: "metal", name: "İç Anadolu Metal San. A.Ş.", tier: "GOLD", city: "Konya", industry: "Metal işleme", activities: ["MANUFACTURER", "CONTRACT_MANUFACTURER"], founded: 1991, employees: "100-250", sell: ["31000000", "30000000"], buy: ["11000000", "23000000"],
  ...
  { key: "yildiz", name: "Yıldız Ofis Malzemeleri", tier: "SILVER", city: "İstanbul", industry: "Ofis ve kırtasiye", activities: ["DISTRIBUTOR"], founded: 2012, employees: "10-50", sell: ["44000000", "56000000"], buy: ["44000000"],
  ...
  { key: "demir", name: "Demir Hırdavat Ltd.", tier: "SILVER", city: "Gaziantep", industry: "Hırdavat ve el aletleri", activities: ["DISTRIBUTOR", "IMPORTER_EXPORTER"], founded: 1998, employees: "10-50", sell: ["27000000", "31000000"], buy: ["27000000"],
  ...
  { key: "gunes", name: "Güneş Temizlik Hizmetleri", tier: "SILVER", city: "İstanbul", industry: "Tesis hizmetleri", activities: ["SERVICE_PROVIDER"], founded: 2010, employees: "250-500", sell: ["76000000"], buy: ["47000000"],
  ...
  { key: "mavi", name: "Mavi Bilişim Çözümleri", tier: "SILVER", city: "İstanbul", industry: "Yazılım ve BT", activities: ["SERVICE_PROVIDER"], founded: 2015, employees: "50-100", sell: ["81000000", "43000000"], buy: ["43000000"],
  ...
  { key: "bursa-oto", name: "Bursa Otomotiv Parça San. A.Ş.", tier: "GOLD", city: "Bursa", industry: "Otomotiv yan sanayi", activities: ["MANUFACTURER", "CONTRACT_MANUFACTURER"], founded: 1996, employees: "500-1000", sell: ["25000000", "31000000"], buy: ["11000000", "31000000"],
  ...
  { key: "kocaeli-plastik", name: "Kocaeli Plastik Ambalaj Ltd.", tier: "SILVER", city: "Kocaeli", industry: "Plastik ve ambalaj", activities: ["MANUFACTURER"], founded: 2009, employees: "50-100", sell: ["24000000", "30000000"], buy: ["13000000"],
  ...
  { key: "izmir-makina", name: "İzmir Makina Endüstri A.Ş.", tier: "GOLD", city: "İzmir", industry: "Makine imalatı", activities: ["MANUFACTURER", "IMPORTER_EXPORTER"], founded: 1985, employees: "100-250", sell: ["23000000", "40000000"], buy: ["31000000", "26000000"],
  ...
  { key: "antalya-tarim", name: "Antalya Tarım Ürünleri Koop.", tier: "SILVER", city: "Antalya", industry: "Tarım ve seracılık", activities: ["MANUFACTURER", "IMPORTER_EXPORTER"], founded: 2004, employees: "100-250", sell: ["10000000", "50000000"], buy: ["21000000", "10000000"],
  ...
  { key: "trakya-elektrik", name: "Trakya Elektrik Malzemeleri", tier: "SILVER", city: "Tekirdağ", industry: "Elektrik malzemeleri", activities: ["DISTRIBUTOR"], founded: 2011, employees: "10-50", sell: ["39000000", "26000000"], buy: ["39000000"],
  ...
  { key: "kayseri-mobilya", name: "Kayseri Mobilya San. Ltd.", tier: "SILVER", city: "Kayseri", industry: "Mobilya", activities: ["MANUFACTURER"], founded: 2000, employees: "100-250", sell: ["56000000"], buy: ["11000000", "30000000"],
  ...
  { key: "samsun-ambalaj", name: "Samsun Oluklu Mukavva A.Ş.", tier: "SILVER", city: "Samsun", industry: "Kağıt ve ambalaj", activities: ["MANUFACTURER"], founded: 2007, employees: "50-100", sell: ["14000000", "24000000"], buy: ["14000000"],
  ...
  { key: "denizli-havlu", name: "Denizli Havlu ve Ev Tekstili", tier: "STANDART", city: "Denizli", industry: "Ev tekstili", activities: ["MANUFACTURER"], founded: 2013, employees: "50-100", sell: ["52000000", "11000000"], buy: ["11000000"], publicProfile: false, verified: false,
...
const PRODUCTS: Pr[] = [
  ...
  // baskent
  { owner: "baskent", name: "Nitril Muayene Eldiveni Pudrasız (100'lü)", cat: "42132200", desc: "Pudrasız, lateks içermeyen nitril muayene eldiveni; S–XL, mavi, 100'lük kutu, kolide 10 kutu. EN 455, CE, tek kullanımlık.", brand: "MedSafe", mpn: "MS-NTR-100", unit: "kutu", kw: ["eldiven", "nitril", "muayene", "tıbbi sarf"], img: "/categories/42000000.webp", tiers: [{ minQty: 10, unitPrice: 165 }, { minQty: 100, unitPrice: 149 }, { minQty: 1000, unitPrice: 138 }], moq: 10, attrs: {"cihaz_sinifi": "Sınıf I", "sertifika": ["CE (MDR)", "ISO 13485", "ÜTS kayıtlı"], "kullanim": "Tek kullanımlık", "sterilizasyon": "Steril değil", "kullanim_alani": ["Sarf malzeme", "Tanı"]} },
  { owner: "baskent", name: "Tek Kullanımlık Enjektör 5 ml (Kilitli)", cat: "42142500", catKw: "enjektör", desc: "Luer-lock 5 ml enjektör, 21G iğneli, steril, tekli blister. Koli 1.000 adet; hastane ve klinik tedariki için palet bazında sevkiyat.", brand: "MedSafe", unit: "adet", kw: ["enjektör", "şırınga", "luer lock"], img: "/categories/42000000.webp", price: 2.9, moq: 1000, attrs: {"cihaz_sinifi": "Sınıf IIa", "sertifika": ["CE (MDR)", "ISO 13485"], "kullanim": "Tek kullanımlık", "sterilizasyon": "Steril (EO)", "kullanim_alani": ["Sarf malzeme"]} },
  { owner: "baskent", name: "Hasta Monitörü 12\" (EKG, SpO2, NIBP)", cat: "42181500", catKw: "monitör", desc: "Taşınabilir hasta başı monitörü: 5 kanal EKG, SpO2, NIBP, sıcaklık, 12\" dokunmatik ekran, 4 saat batarya. CE, 2 yıl garanti, eğitim dahil.", brand: "VitaCare", unit: "adet", kw: ["hasta monitörü", "EKG", "SpO2"], img: "/categories/42000000.webp", moq: 1, attrs: {"cihaz_sinifi": "Sınıf IIb", "sertifika": ["CE (MDR)", "ISO 13485"], "kullanim": "Tekrar kullanılabilir", "kullanim_alani": ["Yoğun bakım", "Tanı"]} },
  // akdeniz
  ...
  // antalya-tarim
  { owner: "antalya-tarim", name: "Salkım Domates (Sera, İhracat Kalite)", cat: "50301600", catKw: "domates", desc: "GlobalGAP sertifikalı sera salkım domatesi, 5 kg karton koli, günlük hasat. Kasım–Haziran sezonu, tır bazında soğuk zincirle sevkiyat.", brand: "Antalya Tarım", unit: "kg", kw: ["domates", "sera", "ihracat", "GlobalGAP"], img: "/categories/10000000.webp", price: 42, moq: 1000, attrs: {"sertifika": ["GlobalGAP"], "saklama": "Soğuk zincir (0-4 °C)", "ambalaj": ["Kutu"]} },
  { owner: "antalya-tarim", name: "Kapya Biber 1. Sınıf", cat: "50301600", catKw: "biber", desc: "Sera kapya biber, 1. sınıf, 8 kg koli; salça ve konserve sanayine ve ihracata. Haftalık 200 ton kapasite, sözleşmeli üretim mümkün.", brand: "Antalya Tarım", unit: "kg", kw: ["kapya biber", "sera", "sözleşmeli üretim"], img: "/categories/50000000.webp", price: 36, moq: 1000, attrs: {"sertifika": ["GlobalGAP"], "saklama": "Soğuk zincir (0-4 °C)", "ambalaj": ["Kutu"]} },
  // trakya-elektrik
  ...
  // kayseri-mobilya
  { owner: "kayseri-mobilya", name: "Ofis Çalışma Masası 160x80 (Metal Ayak)", cat: "56112100", catKw: "masa", desc: "Melamin kaplı 25 mm tabla, toz boyalı metal ayak, kablo kanalı. 160x80 cm, 10 renk; proje bazında özel ölçü ve montajlı teslim.", brand: "Kayseri Mobilya", unit: "adet", kw: ["ofis masası", "çalışma masası", "ofis mobilyası"], img: "/categories/56000000.webp", tiers: [{ minQty: 10, unitPrice: 5900 }, { minQty: 100, unitPrice: 5250 }], moq: 10, attrs: {"kullanim_alani": ["Ofis"], "malzeme": ["MDF / sunta", "Metal"], "montaj": "Demonte (flat-pack)", "sertifika": ["TSE", "E1 (formaldehit)"]} },
  { owner: "kayseri-mobilya", name: "Otel Odası Mobilya Seti (Proje)", cat: "56101500", catKw: "mobilya", desc: "Yatak başlığı, komodin, bagaj sehpası, çalışma masası ve dolap; otel projeleri için özel tasarım set. FSC sertifikalı MDF, laminat ve kaplama seçenekleri.", brand: "Kayseri Mobilya", unit: "set", kw: ["otel mobilyası", "proje mobilyası"], img: "/categories/56000000.webp", moq: 20, attrs: {"kullanim_alani": ["Otel / kontrakt"], "malzeme": ["MDF / sunta", "Masif ahşap"], "montaj": "Kurulu", "sertifika": ["E1 (formaldehit)"]} },
  // samsun-ambalaj
  ...
  // baskent ek
  { owner: "baskent", name: "Cerrahi Maske Tip IIR (50'li)", cat: "42131700", catKw: "maske", desc: "3 katlı cerrahi maske Tip IIR, EN 14683, %98 BFE, 50'lik kutu, kolide 40 kutu. CE belgeli, hastane ihalelerine uygun raporlar mevcut.", brand: "MedSafe", unit: "kutu", kw: ["cerrahi maske", "tip IIR", "tıbbi sarf"], img: "/categories/42000000.webp", tiers: [{ minQty: 40, unitPrice: 48 }, { minQty: 400, unitPrice: 42 }], moq: 40, attrs: {"cihaz_sinifi": "Sınıf I", "sertifika": ["CE (MDR)", "ÜTS kayıtlı"], "kullanim": "Tek kullanımlık", "sterilizasyon": "Steril değil", "kullanim_alani": ["Cerrahi", "Sarf malzeme"]} },
  // izmir ek
  ...
  // yildiz ek
  { owner: "yildiz", name: "Toner Kartuş (Uyumlu) HP 26A", cat: "44103100", catKw: "toner", desc: "HP CF226A uyumlu toner kartuşu, 3.100 sayfa, ISO 19752; 1 yıl garanti. Kurumsal tedarikte aylık fatura ve toplu sipariş indirimi.", brand: "PrintFine", mpn: "PF-26A", unit: "adet", kw: ["toner", "kartuş", "HP 26A"], img: "/categories/44000000.webp", price: 640, moq: 2, attrs: {"urun_grubu": ["Yazıcı ve sarf"], "durum": "Sıfır", "uyumluluk": "HP LaserJet Pro M402 / M426"} },
];
...
function assertPhotos(): void {
  ...
  const check = (src: string) => {
    const file = resolve(__dirname, "../../../../apps/web/public", src.replace(/^\//, ""));
    if (!existsSync(file)) missing.add(src);
  };
  for (const p of PRODUCTS) check(p.img);
  for (const d of COMPANIES) check(segmentPhoto(d.sell[0] ?? "81000000"));
  if (missing.size) throw new Error(`Kategori fotoğrafı bulunamadı: ${[...missing].join(", ")}`);
}
...
async function main() {
  ...
  for (const d of COMPANIES) {
    ...
    const data = {
      ...
      aboutText: d.about, services: d.services, certifications: d.certs, photos: [segmentPhoto(d.sell[0] ?? "81000000")],
      coverImageUrl: segmentPhoto(d.sell[0] ?? "81000000"),
