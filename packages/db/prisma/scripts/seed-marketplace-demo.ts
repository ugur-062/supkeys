...
const COMPANIES: Co[] = [
  ...
  { key: "yildiz", name: "Yıldız Ofis Malzemeleri", tier: "SILVER", city: "İstanbul", industry: "Ofis ve kırtasiye", activities: ["DISTRIBUTOR"], founded: 2012, employees: "10-50", cover: "office,supplies", sell: ["44000000", "56000000"], buy: ["44000000"],
  ...
  { key: "demir", name: "Demir Hırdavat Ltd.", tier: "SILVER", city: "Gaziantep", industry: "Hırdavat ve el aletleri", activities: ["DISTRIBUTOR", "IMPORTER_EXPORTER"], founded: 1998, employees: "10-50", cover: "hardware,tools", sell: ["27000000", "31000000"], buy: ["27000000"],
  ...
  { key: "gunes", name: "Güneş Temizlik Hizmetleri", tier: "SILVER", city: "İstanbul", industry: "Tesis hizmetleri", activities: ["SERVICE_PROVIDER"], founded: 2010, employees: "250-500", cover: "cleaning,service", sell: ["76000000"], buy: ["47000000"],
  ...
  { key: "trakya-elektrik", name: "Trakya Elektrik Malzemeleri", tier: "SILVER", city: "Tekirdağ", industry: "Elektrik malzemeleri", activities: ["DISTRIBUTOR"], founded: 2011, employees: "10-50", cover: "electrical,cable", sell: ["39000000", "26000000"], buy: ["39000000"],
  ...
  { key: "samsun-ambalaj", name: "Samsun Oluklu Mukavva A.Ş.", tier: "SILVER", city: "Samsun", industry: "Kağıt ve ambalaj", activities: ["MANUFACTURER"], founded: 2007, employees: "50-100", cover: "cardboard,boxes", sell: ["14000000", "24000000"], buy: ["14000000"],
...
const PRODUCTS: Pr[] = [
  ...
  { owner: "marmara", name: "Konserve Bezelye 400 g", cat: "50192400", catKw: "konserve", desc: "Taze hasat bezelye, 400 g teneke, kolide 24 adet. Özel markalı üretim yapılır; minimum sipariş bir palet (2.400 adet).", brand: "Marmara", unit: "adet", kw: ["konserve", "bezelye", "private label"], img: "canned,food", price: 24.5, moq: 2400, attrs: {"sertifika": ["ISO 22000", "HACCP"], "saklama": "Oda sıcaklığı", "ambalaj": ["Teneke"], "raf_omru": 36} },
  { owner: "marmara", name: "Kornişon Turşu 720 ml Cam Kavanoz", cat: "50192400", catKw: "turşu", desc: "3–6 cm boy kornişon, 720 ml cam kavanoz, kolide 12. İhracat kalitesi, BRC sertifikalı tesis. Etiket ve kapak rengi özelleştirilebilir.", brand: "Marmara", unit: "adet", kw: ["turşu", "kornişon", "ihracat"], img: "pickles,jar", price: 41, moq: 1200, attrs: {"sertifika": ["BRC", "HACCP"], "saklama": "Oda sıcaklığı", "ambalaj": ["Cam kavanoz"], "raf_omru": 24} },
  // toros
  { owner: "toros", name: "Kostik Soda %99 (Sodyum Hidroksit) 25 kg", cat: "12352300", catKw: "hidroksit", desc: "%99 saflıkta pul kostik soda, 25 kg PE torba, paletli. Tekstil, sabun ve su arıtma sektörü için; analiz sertifikası her partide.", brand: "Toros Kimya", unit: "kg", kw: ["kostik", "sodyum hidroksit", "NaOH"], img: "chemical,industrial", tiers: [{ minQty: 1000, unitPrice: 24 }, { minQty: 10000, unitPrice: 21.5 }], moq: 1000, attrs: {"fiziksel_hal": "Katı", "saflik": 99, "ambalaj": ["Torba"], "tehlike": ["Aşındırıcı"], "sertifika": ["ISO 9001", "SDS mevcut", "REACH"]} },
  { owner: "toros", name: "Endüstriyel Yağ Sökücü Konsantre 20 L", cat: "47131800", catKw: "temizleyici", desc: "Makine ve zemin yağlarını çözen alkali konsantre, 1:20 seyreltme. Gıda tesislerinde kullanıma uygun (NSF A1 muadili), 20 L bidon.", brand: "Toros Kimya", mpn: "TK-YS-20", unit: "adet", kw: ["yağ sökücü", "endüstriyel temizlik", "alkali"], img: "cleaning,chemical", price: 1450, moq: 4, attrs: {"urun_tipi": ["Endüstriyel kimyasal", "Genel temizlik"], "konsantrasyon": "Konsantre", "ambalaj": ["Bidon"], "sertifika": ["ISO 9001", "Gıda temasına uygun"]} },
  { owner: "toros", name: "Polielektrolit Anyonik Flokülant 25 kg", cat: "12352300", catKw: "polimer", desc: "Atık su arıtma için yüksek molekül ağırlıklı anyonik polielektrolit. Çamur susuzlaştırma ve çöktürme; 25 kg torba, dozaj danışmanlığı dahil.", brand: "Toros Kimya", unit: "kg", kw: ["flokülant", "polielektrolit", "arıtma"], img: "water,treatment", moq: 25, attrs: {"fiziksel_hal": "Toz", "ambalaj": ["Torba"], "tehlike": ["Tehlikesiz"], "sertifika": ["ISO 9001", "SDS mevcut"]} },
  // karadeniz
  { owner: "karadeniz", name: "Kuru Tip Trafo 1000 kVA 34,5/0,4 kV", cat: "39121000", catKw: "trafo", desc: "Reçine döküm kuru tip dağıtım trafosu, 1000 kVA, 34,5/0,4 kV, Dyn11. IEC 60076-11, 2 yıl garanti; devreye alma hizmeti opsiyonel.", brand: "Karadeniz", unit: "adet", kw: ["trafo", "kuru tip", "dağıtım trafosu", "34.5 kV"], img: "transformer,electric", moq: 1, attrs: {"gerilim": "Orta gerilim (1-36 kV)", "koruma_sinifi": "IP20", "kullanim_alani": ["Enerji dağıtımı", "Sanayi"], "sertifika": ["CE", "IEC", "TSE"]} },
  { owner: "karadeniz", name: "GES Kurulumu (Çatı) — kW Başına", cat: "26111700", catKw: "güneş", desc: "Sanayi çatısına anahtar teslim güneş enerjisi santrali: panel, inverter, konstrüksiyon, AG pano ve şebeke bağlantı projesi. 25 yıl panel performans garantisi.", brand: "Karadeniz", unit: "kW", kw: ["GES", "güneş enerjisi", "çatı GES", "EPC"], img: "solar,roof", price: 19500, moq: 100, attrs: {"kaynak": "Güneş (PV)", "gerilim": "Alçak gerilim (<1 kV)", "durum": "Sıfır", "sertifika": ["CE", "IEC"]} },
  { owner: "karadeniz", name: "Kompanzasyon Panosu 400 kVAr", cat: "39121000", catKw: "pano", desc: "Reaktif güç kompanzasyon panosu, 400 kVAr, 12 kademe, harmonik filtreli. Pano içi bakır bara, kontaktörler Schneider; devreye alma dahil.", brand: "Karadeniz", unit: "adet", kw: ["kompanzasyon", "pano", "reaktif güç"], img: "electrical,panel", price: 185000, moq: 1, attrs: {"gerilim": "Alçak gerilim (<1 kV)", "koruma_sinifi": "IP54", "kullanim_alani": ["Sanayi", "Enerji dağıtımı"], "sertifika": ["CE", "TSE"]} },
  // baskent
  { owner: "baskent", name: "Nitril Muayene Eldiveni Pudrasız (100'lü)", cat: "42132200", desc: "Pudrasız, lateks içermeyen nitril muayene eldiveni; S–XL, mavi, 100'lük kutu, kolide 10 kutu. EN 455, CE, tek kullanımlık.", brand: "MedSafe", mpn: "MS-NTR-100", unit: "kutu", kw: ["eldiven", "nitril", "muayene", "tıbbi sarf"], img: "gloves,medical", tiers: [{ minQty: 10, unitPrice: 165 }, { minQty: 100, unitPrice: 149 }, { minQty: 1000, unitPrice: 138 }], moq: 10, attrs: {"cihaz_sinifi": "Sınıf I", "sertifika": ["CE (MDR)", "ISO 13485", "ÜTS kayıtlı"], "kullanim": "Tek kullanımlık", "sterilizasyon": "Steril değil", "kullanim_alani": ["Sarf malzeme", "Tanı"]} },
  { owner: "baskent", name: "Tek Kullanımlık Enjektör 5 ml (Kilitli)", cat: "42142500", catKw: "enjektör", desc: "Luer-lock 5 ml enjektör, 21G iğneli, steril, tekli blister. Koli 1.000 adet; hastane ve klinik tedariki için palet bazında sevkiyat.", brand: "MedSafe", unit: "adet", kw: ["enjektör", "şırınga", "luer lock"], img: "syringe,medical", price: 2.9, moq: 1000, attrs: {"cihaz_sinifi": "Sınıf IIa", "sertifika": ["CE (MDR)", "ISO 13485"], "kullanim": "Tek kullanımlık", "sterilizasyon": "Steril (EO)", "kullanim_alani": ["Sarf malzeme"]} },
  { owner: "baskent", name: "Hasta Monitörü 12\" (EKG, SpO2, NIBP)", cat: "42181500", catKw: "monitör", desc: "Taşınabilir hasta başı monitörü: 5 kanal EKG, SpO2, NIBP, sıcaklık, 12\" dokunmatik ekran, 4 saat batarya. CE, 2 yıl garanti, eğitim dahil.", brand: "VitaCare", unit: "adet", kw: ["hasta monitörü", "EKG", "SpO2"], img: "hospital,monitor", moq: 1, attrs: {"cihaz_sinifi": "Sınıf IIb", "sertifika": ["CE (MDR)", "ISO 13485"], "kullanim": "Tekrar kullanılabilir", "kullanim_alani": ["Yoğun bakım", "Tanı"]} },
  // akdeniz
  { owner: "akdeniz", name: "Soğuk Hava Deposu Kiralama (Palet/Ay)", cat: "78131600", catKw: "depolama", desc: "Mersin'de -18°C ve +4°C soğuk depo, palet-ay bazında kiralama. WMS ile stok görünürlüğü, 7/24 giriş-çıkış, sigortalı depolama.", brand: "Akdeniz Lojistik", unit: "palet", kw: ["soğuk depo", "depolama", "Mersin"], img: "cold,warehouse", price: 420, moq: 20, attrs: {"tasima_modu": ["Karayolu"], "hizmet_tipi": ["Depolama", "Soğuk zincir"], "kapsam": "Yurt içi", "yetki_belgesi": ["L2"]} },
  { owner: "akdeniz", name: "Komple Tır Nakliye İstanbul–Mersin", cat: "78101800", catKw: "nakliye", desc: "13,6 m tenteli tır ile komple yük taşıma, İstanbul–Mersin arası 24 saat teslim. Sigortalı, GPS takipli, e-irsaliye entegrasyonu.", brand: "Akdeniz Lojistik", unit: "sefer", kw: ["nakliye", "tır", "komple yük"], img: "truck,highway", price: 28500, moq: 1, attrs: {"tasima_modu": ["Karayolu"], "hizmet_tipi": ["Komple (FTL)"], "kapsam": "Yurt içi", "yetki_belgesi": ["K1", "ADR"]} },
  // metal
  { owner: "metal", name: "Lazer Kesim Sac Parça (DKP 2 mm)", cat: "31163200", catKw: "kesim", desc: "Fiber lazer ile DKP 2 mm sac parça kesimi; çizime göre üretim, 6 kW lazer, ±0,1 mm tolerans. Kilogram bazında fiyat, DXF/DWG ile teklif.", brand: "İç Anadolu Metal", unit: "kg", kw: ["lazer kesim", "sac parça", "fason"], img: "laser,cutting", price: 62, moq: 100, attrs: {"imalat_yontemi": ["Sac işleme"], "malzeme": ["Çelik"], "tolerans": "±0,1 mm", "yuzey": ["Ham"]} },
  ...
  // kayseri-mobilya
  { owner: "kayseri-mobilya", name: "Ofis Çalışma Masası 160x80 (Metal Ayak)", cat: "56112100", catKw: "masa", desc: "Melamin kaplı 25 mm tabla, toz boyalı metal ayak, kablo kanalı. 160x80 cm, 10 renk; proje bazında özel ölçü ve montajlı teslim.", brand: "Kayseri Mobilya", unit: "adet", kw: ["ofis masası", "çalışma masası", "ofis mobilyası"], img: "office,desk", tiers: [{ minQty: 10, unitPrice: 5900 }, { minQty: 100, unitPrice: 5250 }], moq: 10, attrs: {"kullanim_alani": ["Ofis"], "malzeme": ["MDF / sunta", "Metal"], "montaj": "Demonte (flat-pack)", "sertifika": ["TSE", "E1 (formaldehit)"]} },
  { owner: "kayseri-mobilya", name: "Otel Odası Mobilya Seti (Proje)", cat: "56101500", catKw: "mobilya", desc: "Yatak başlığı, komodin, bagaj sehpası, çalışma masası ve dolap; otel projeleri için özel tasarım set. FSC sertifikalı MDF, laminat ve kaplama seçenekleri.", brand: "Kayseri Mobilya", unit: "set", kw: ["otel mobilyası", "proje mobilyası"], img: "hotel,room", moq: 20, attrs: {"kullanim_alani": ["Otel / kontrakt"], "malzeme": ["MDF / sunta", "Masif ahşap"], "montaj": "Kurulu", "sertifika": ["E1 (formaldehit)"]} },
  // samsun-ambalaj
  { owner: "samsun-ambalaj", name: "Oluklu Koli 40x30x30 cm (5 Katlı)", cat: "14121506", desc: "BC dalga 5 katlı oluklu mukavva koli 40x30x30 cm, 25 kg taşıma. 1 renk flekso baskı dahil; palet 500 adet, özel ölçü 5 gün termin.", brand: "Samsun Ambalaj", unit: "adet", kw: ["oluklu koli", "karton kutu", "5 katlı"], img: "cardboard,box", tiers: [{ minQty: 500, unitPrice: 28 }, { minQty: 5000, unitPrice: 24.5 }], moq: 500, attrs: {"kagit_tipi": ["Oluklu mukavva"], "form": "Kutu", "geri_donusum": "Geri dönüştürülmüş", "sertifika": ["ISO 9001"]} },
  { owner: "samsun-ambalaj", name: "Fındık İhracat Kolisi 25 kg", cat: "14121506", desc: "Fındık ve kuruyemiş ihracatı için 25 kg kapasiteli 3 katlı koli, nem bariyerli iç kaplama, 2 renk baskı. Haftalık 100 bin adet kapasite.", brand: "Samsun Ambalaj", unit: "adet", kw: ["fındık kolisi", "ihracat ambalajı"], img: "hazelnut,box", price: 19.5, moq: 1000, attrs: {"kagit_tipi": ["Oluklu mukavva", "Kraft"], "form": "Kutu", "sertifika": ["Gıdaya uygun", "ISO 9001"]} },
  // anadolu (hizmet ürünleri)
  { owner: "anadolu", name: "Prefabrik Şantiye Konteyneri 7 m (Kiralık)", cat: "72121400", catKw: "prefabrik", desc: "Ofis ve yatakhane tipi 7 m prefabrik konteyner kiralama; elektrik, klima ve mobilya dahil. Ay bazında, kurulum ve nakliye Türkiye geneli.", brand: "Anadolu", unit: "ay", kw: ["şantiye konteyneri", "prefabrik", "kiralık"], img: "container,site", price: 6500, moq: 3, attrs: {"hizmet_tipi": ["Yeni yapı"], "proje_olcegi": "Ticari", "kapsam": "Malzeme dahil"} },
  { owner: "anadolu", name: "Endüstriyel Zemin Betonu (Helikopter Perdahlı, m²)", cat: "72121400", catKw: "beton", desc: "Fabrika ve depo zeminleri için çelik lifli C30 beton, yüzey sertleştirici ve helikopter perdah. m² bazında, 7 gün kür sonrası teslim.", brand: "Anadolu", unit: "m²", kw: ["endüstriyel zemin", "perdah beton", "depo zemini"], img: "concrete,floor", price: 720, moq: 500, attrs: {"hizmet_tipi": ["Yeni yapı", "Zemin işleri"], "proje_olcegi": "Endüstriyel", "kapsam": "Malzeme dahil"} },
  // akdeniz ek
  { owner: "akdeniz", name: "Gümrükleme Hizmeti (Beyanname Başına)", cat: "78131600", catKw: "gümrük", desc: "İthalat ve ihracat gümrük müşavirliği; beyanname, tarife danışmanlığı, Mersin ve Ambarlı limanlarında operasyon. Beyanname başına sabit ücret.", brand: "Akdeniz Lojistik", unit: "adet", kw: ["gümrükleme", "gümrük müşavirliği", "ithalat"], img: "port,container", price: 2400, moq: 1, attrs: {"tasima_modu": ["Multimodal"], "hizmet_tipi": ["Gümrükleme"], "kapsam": "İthalat", "yetki_belgesi": ["Gümrük müşavirliği"]} },
  // baskent ek
  { owner: "baskent", name: "Cerrahi Maske Tip IIR (50'li)", cat: "42131700", catKw: "maske", desc: "3 katlı cerrahi maske Tip IIR, EN 14683, %98 BFE, 50'lik kutu, kolide 40 kutu. CE belgeli, hastane ihalelerine uygun raporlar mevcut.", brand: "MedSafe", unit: "kutu", kw: ["cerrahi maske", "tip IIR", "tıbbi sarf"], img: "surgical,mask", tiers: [{ minQty: 40, unitPrice: 48 }, { minQty: 400, unitPrice: 42 }], moq: 40, attrs: {"cihaz_sinifi": "Sınıf I", "sertifika": ["CE (MDR)", "ÜTS kayıtlı"], "kullanim": "Tek kullanımlık", "sterilizasyon": "Steril değil", "kullanim_alani": ["Cerrahi", "Sarf malzeme"]} },
  // izmir ek
  { owner: "izmir-makina", name: "Plakalı Isı Eşanjörü 150 kW", cat: "40101800", catKw: "eşanjör", desc: "Contalı plakalı ısı eşanjörü 150 kW, AISI 316 plaka, EPDM conta; gıda ve HVAC uygulamaları. Termal hesap ve seçim mühendislik ekibimizce yapılır.", brand: "İzmir Makina", unit: "adet", kw: ["eşanjör", "ısı değiştirici", "plakalı"], img: "heat,exchanger", price: 96000, moq: 1, attrs: {"malzeme": ["Paslanmaz çelik"], "calisma_basinci": 16, "calisma_sicakligi": 120, "standart": ["EN"]} },
  // metal ek
  { owner: "metal", name: "Paslanmaz Sac 304 2B 1,5 mm (1250x2500)", cat: "30264800", catKw: "paslanmaz", desc: "AISI 304 2B yüzey paslanmaz sac 1,5 mm, 1250x2500 mm, PVC koruma filmli. Ton bazında, sertifikalı (3.1 EN 10204); gıda ve mutfak imalatı için.", brand: "İç Anadolu Metal", unit: "adet", kw: ["paslanmaz sac", "304", "2B"], img: "stainless,sheet", price: 4150, moq: 10, attrs: {"malzeme": ["Çelik"], "uygulama": ["İnce yapı"], "standart": ["EN", "ASTM"]} },
  // yildiz ek
  { owner: "yildiz", name: "Toner Kartuş (Uyumlu) HP 26A", cat: "44103100", catKw: "toner", desc: "HP CF226A uyumlu toner kartuşu, 3.100 sayfa, ISO 19752; 1 yıl garanti. Kurumsal tedarikte aylık fatura ve toplu sipariş indirimi.", brand: "PrintFine", mpn: "PF-26A", unit: "adet", kw: ["toner", "kartuş", "HP 26A"], img: "printer,toner", price: 640, moq: 2, attrs: {"urun_grubu": ["Yazıcı ve sarf"], "durum": "Sıfır", "uyumluluk": "HP LaserJet Pro M402 / M426"} },
];
...
/* ───────────────────────── Ana akış ───────────────────────── */
/**
 * NİTELİK DENETİMİ — fail-loud. Demo ürünlerin `attrs` anahtarları kategori
 * ata zincirindeki matriste TANIMLI olmalı ve kapalı listelerde değer
 ...
 * yani veri var görünür ama hiçbir yerde işe yaramaz.
 */
