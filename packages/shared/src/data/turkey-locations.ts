 ...
 * Kaynak: T.C. İçişleri Bakanlığı / Wikipedia "Türkiye'nin il ve ilçeleri" listesi.
 *
 * NOT: Liste kayıt formlarında il/ilçe seçici için kullanılır.
 * Mahalle/köy/belde seviyesinde değildir; sadece ilçe seviyesi.
 */
...
export const TURKEY_LOCATIONS: TurkishLocation[] = [
  {
    il: "Adana",
    ilceler: [
      "Aladağ",
...
export function getDistrictsByCity(cityName: string): string[] {
  const found = TURKEY_LOCATIONS.find((l) => l.il === cityName);
